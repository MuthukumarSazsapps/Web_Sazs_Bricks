      ...
      <div className="container">
        ...
        <div className="row justify-content-center">
          <div className="col-lg-12">
            <div className="foot">
              <p>
                © 2022 Copyrights by <a href="#" className="text-white text-decoration-underline">Sazsapps</a> All Rights Reserved by <a href="#" className="text-white text-decoration-underline"> SazsBricks </a>
              </p>
            </div>
          </div>
        </div>

...
const Contact = () => {
  ...
  return (
    <section className="contact section-padding bg-gradient style-1" data-scroll-index="6">
          ...
          <div className="row justify-content-center">
            <div className="col-lg-5">
              <div className="contact_info text-white">
                <p className="wow fadeInUp">SUPPORT 24/7</p>
                ...
                <a href="https://www.google.com/maps/dir/9.1726552,77.8710279/sazs+apps/@9.1753793,77.8680465,17z/data=!4m9!4m8!1m1!4e1!1m5!1m1!1s0x3b06b3486c024f79:0x8901bf7122369151!2m2!1d77.8715352!2d9.1785572?entry=ttu" target='blank' className="wow fadeInUp">get direction</a>
              </div>
            </div>

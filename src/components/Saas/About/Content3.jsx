        ...
        <div className="row align-items-center">
          <div className="col-lg-4 order-2 order-lg-0">
            <div className="section-head mb-30 style-5">
              <h2>EASY TO <span>USE</span> </h2>
            </div>
            <p>
            Our software boasts an intuitive design, making it exceptionally user-friendly. With a straightforward interface and user-centric features, navigating through tasks becomes seamless. Whether you're a novice or an expert, our software ensures a hassle-free experience, enabling you to accomplish tasks efficiently and effortlessly.
            </p>
            {/* <p className="mt-20">
              { texts.text2 }
            </p> */}
            <div className="d-flex align-items-center mt-70">
              ...
              <div className="inf">
                <h4 className="color-blue5 mb-0 lh-1">160+</h4>
